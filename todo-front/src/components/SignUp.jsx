 ...
 * - fetch는 js 기본 내장 되어있지만 axio는 별도 설치(라이브러리 다운로드) 필요
...
const SignUpComponent = () => {
  ...
  return(
    <div className='signup-container'>
      <label> 
        ID : 
        <input type="text" onChange={idCheckHandler} className={idValidation ? '' : 'id-error'} value={id} />
      </label>
      <label> 
        PW : 
